          ...
          widgets: [
            {
              ...
              details: {
                css: {
                  mobile:
                    'position:fixed,left:20px,top:60%,transform:translateY(-50%),z-index:99',
                  desktop:
                    'position:fixed,left:20px,top:30%,transform:translateY(-50%),z-index:99',
                },
                type: 'floating',
                layout: 'floating',
                  ...
                  details: {
                    ...
                    auxiliary_details: {
                      ...
                      address: {
                        ...
                        state: 'Gujarat',
                        address:
                          'New Pushpakunj Society, Katargam, Surat, Gujarat 395004, India',
                        country: 'India',
                        zipcode: '395004',
                        location: {
                          lat: 21.2212192,
      ...
      if (
        ...
        document.addEventListener('DOMContentLoaded', async () => {
          ...
          if (googleReviewApps.length) {
            ...
            let { type, layout_style, layout, container_id, css } =
              val?.result?.data?.widgets[0]?.details;
              ...
              switch (type) {
                ...
                case 'badge':
                  ...
                  if (layout_style == 'badge_monochromatic_fill') {
                    script.src =
                      APP_URL + 'widgets/badge_monochromatic_fill.js';
                  }
